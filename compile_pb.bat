...
echo.
call ./node_modules/.bin/pbjs --force-number --dependency protobufjs/minimal.js --keep-case --target static-module --wrap commonjs --out ./assets/scripts/pb/proto.js ./pb/*.proto
echo.


echo 开始编译.js文件，生成.d.ts文件...
echo.
call ./node_modules/.bin/pbts --out ./assets/scripts/pb/proto.d.ts ./assets/scripts/pb/*.js
echo.
